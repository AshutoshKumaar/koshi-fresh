...
export function Textarea({ className, error, helperText, disabled, ...props }: TextareaProps) {
  return (
    <div className="w-full font-sans">
      <textarea
        disabled={disabled}
        className={cn(
          "flex min-h-[100px] w-full rounded-lg border border-stone bg-white px-4 py-3 text-sm text-obsidian placeholder:text-stone/60 outline-hidden transition-all duration-200 resize-y",
